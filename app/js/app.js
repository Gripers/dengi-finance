...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("click", function (e) {
    if (e.target.className != null) {
      if (
        e.target.className == "header__nav--burger" ||
        e.target.className == "header__nav--burger burger__active"
      ) {
        document
        ...
        if (document.querySelector(".burger__active") != null) {
          ...
          document.body.style =
            "overflow-y: hidden; padding-right:" + scrollW + "px;";
        } else {
  ...
  function MobileResize(e) {
    if (e.matches) {
      if (nav.hasAttribute("style")) {
        ...
        document
          .querySelector(".header__nav--burger")
          .classList.remove("burger__active");
